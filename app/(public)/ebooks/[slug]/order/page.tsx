...
export default function OrderPage() {
  ...
  const [book, setBook] = useState<{ id: string; title: string; price: number } | null>(null);
  ...
  if (!book) {
    return (
      <div className="container-narrow py-10">
        <p className="text-sm text-ink/60">전자책 정보를 불러오는 중…</p>
      </div>
    );
  }
  ...
  return (
    <div className="container-narrow py-10">
      ...
      <p className="text-ink/60 mb-8">{book.price === 0 ? '무료' : `${book.price.toLocaleString()}원`}</p>
